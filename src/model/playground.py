...
if __name__ == '__main__':
    ...
    batch_size = 8
    trainset = 'C:/Users/spbsp/OneDrive - Danmarks Tekniske Universitet/Skrivebord/DTU/Thesis/Project/data/raw/spectrograms_csegm'
    ...
    show(example_images, 'Example spectos', save_path='assets/example.png')
